...
import event_management.exception.CategoryNotFoundException;
import event_management.exception.CategoryNotValidException;
...
class CategoryServiceTest {
    ...
    void saveInvalidCategory() {
        ...
        // When and Then
        assertThrows(CategoryNotValidException.class, () -> categoryService.saveCategory(category));
        verify(categoryRepository).save(category);
    }
    ...
    void createExistingCategory() {
        ...
        // When and Then
        assertThrows(AlreadyExistsException.class, () -> categoryService.createCategory(category));
        verify(categoryRepository).existsByName(categoryName);
    }
    ...
    void updateCategoryWithNameAlreadyExists() {
        ...
        // When and Then
        assertThrows(AlreadyExistsException.class, () -> categoryService.updateCategory(categoryId, categoryDto));
        verify(categoryRepository).findById(categoryId);
        verify(categoryRepository).existsByName(categoryDto.getName());
